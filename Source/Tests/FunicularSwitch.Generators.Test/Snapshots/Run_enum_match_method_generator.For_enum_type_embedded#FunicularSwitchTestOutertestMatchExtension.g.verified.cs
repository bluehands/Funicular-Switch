...
namespace FunicularSwitch.Test
{
	public static partial class Outer_testMatchExtension
	{
		...
		[global::System.Diagnostics.DebuggerStepThrough]
		public static async global::System.Threading.Tasks.Task<T> Match<T>(this FunicularSwitch.Test.Outer.test test, global::System.Func<global::System.Threading.Tasks.Task<T>> one, global::System.Func<global::System.Threading.Tasks.Task<T>> two) =>
		test switch
		{
			FunicularSwitch.Test.Outer.test.one => await one().ConfigureAwait(false),
			FunicularSwitch.Test.Outer.test.two => await two().ConfigureAwait(false),
			_ => throw new global::System.ArgumentException($"Unknown enum value from FunicularSwitch.Test.Outer.test: {test.GetType().Name}")
		};
