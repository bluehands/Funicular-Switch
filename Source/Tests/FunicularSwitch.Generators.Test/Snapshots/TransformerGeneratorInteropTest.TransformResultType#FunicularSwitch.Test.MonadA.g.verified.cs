...
#pragma warning disable 1591
	...
	public abstract partial class MonadA<T> : MonadA, global::System.Collections.Generic.IEnumerable<T>
	{
		...
		public new static MonadA<T> Error(String message) => Error<T>(message);
		...
		bool Equals(MonadA<T> other) => this switch
		{
			Ok_ ok => ok.Equals((object)other),
			Error_ error => error.Equals((object)other),
			_ => throw new global::System.InvalidOperationException($"Unexpected type derived from {nameof(MonadA<T>)}")
		};
		...
		public T1 Match<T1>( global::System.Func<T, T1> ok,  global::System.Func<String, T1> error)
		{
			return this switch
			{
				Ok_ okMonadA => ok(okMonadA.Value),
				Error_ errorMonadA => error(errorMonadA.Details),
		...
		public async global::System.Threading.Tasks.Task<T1> Match<T1>( global::System.Func<T, global::System.Threading.Tasks.Task<T1>> ok,  global::System.Func<String, global::System.Threading.Tasks.Task<T1>> error)
		{
			return this switch
			{
				Ok_ okMonadA => await ok(okMonadA.Value).ConfigureAwait(false),
				Error_ errorMonadA => await error(errorMonadA.Details).ConfigureAwait(false),
				_ => throw new global::System.InvalidOperationException($"Unexpected derived result type: {GetType()}")
			};
		}
			 ...
			 global::System.Func<T, global::System.Threading.Tasks.Task<T1>> map)
		{
			switch (this)
			{
				case Ok_ ok:
					try
					{
						return MonadA.Ok(await map(ok.Value).ConfigureAwait(false));
					}
					// ReSharper disable once RedundantCatchClause
#pragma warning disable CS0168 // Variable is declared but never used
					catch (global::System.Exception e)
#pragma warning restore CS0168 // Variable is declared but never used
		...
		public sealed partial class Ok_ : MonadA<T>
		{
			public T Value { get; }
		...
		public sealed partial class Error_ : MonadA<T>
		{
	...
	public readonly partial struct MonadAError : global::System.IEquatable<MonadAError>
	{
		readonly String _details;

		internal MonadAError(String details) => _details = details;

		[global::System.Diagnostics.Contracts.Pure]
		public MonadA<T> WithOk<T>() => MonadA.Error<T>(_details);

		[global::System.Diagnostics.Contracts.PureAttribute]
		public bool Equals(MonadAError other) => _details.Equals(other._details);

		[global::System.Diagnostics.Contracts.PureAttribute]
		public override bool Equals(object? obj) => obj is MonadAError other && Equals(other);

		[global::System.Diagnostics.Contracts.PureAttribute]
		public override int GetHashCode() => _details.GetHashCode();

		[global::System.Diagnostics.Contracts.PureAttribute]
		public static bool operator ==(MonadAError left, MonadAError right) => left.Equals(right);
	...
	public static partial class MonadAExtension
	{
		...
		public static MonadA<T> MapError<T>(this MonadA<T> result,  global::System.Func<String, String> mapError)
		{
			if (result is MonadA<T>.Error_ e)
				return MonadA.Error<T>(mapError(e.Details));
			return result;
		}
...
namespace FunicularSwitch.Test.Extensions
{
	public static partial class MonadAExtension
	{
		...
		public static global::System.Collections.Generic.IEnumerable<T1> Choose<T, T1>(
			...
			global::System.Func<T, MonadA<T1>> choose,
		...
		public static global::System.Collections.Generic.IEnumerable<T> Choose<T>(
			this global::System.Collections.Generic.IEnumerable<MonadA<T>> results,
			global::System.Action<String> onError)
			=> results
				.Where(r =>
		...
		public static MonadA<T> First<T>(this global::System.Collections.Generic.IEnumerable<T> candidates,  global::System.Func<T, bool> predicate,  global::System.Func<String> noMatch) =>
			candidates
