...
namespace FunicularSwitch.Generators.Consumer
{
	internal static partial class InternalEnumParent_InternalEnumMatchExtension
	{
		...
		[global::System.Diagnostics.DebuggerStepThrough]
		public static async global::System.Threading.Tasks.Task<T> Match<T>(this FunicularSwitch.Generators.Consumer.InternalEnumParent.InternalEnum internalEnum, global::System.Func<global::System.Threading.Tasks.Task<T>> one, global::System.Func<global::System.Threading.Tasks.Task<T>> two) =>
		internalEnum switch
		{
			FunicularSwitch.Generators.Consumer.InternalEnumParent.InternalEnum.One => await one().ConfigureAwait(false),
			FunicularSwitch.Generators.Consumer.InternalEnumParent.InternalEnum.Two => await two().ConfigureAwait(false),
			_ => throw new global::System.ArgumentException($"Unknown enum value from FunicularSwitch.Generators.Consumer.InternalEnumParent.InternalEnum: {internalEnum.GetType().Name}")
		};
