...
namespace FluentAssertions.Common
{
	internal static partial class CSharpAccessModifierMatchExtension
	{
		...
		[global::System.Diagnostics.DebuggerStepThrough]
		public static async global::System.Threading.Tasks.Task<T> Match<T>(this FluentAssertions.Common.CSharpAccessModifier cSharpAccessModifier, global::System.Func<global::System.Threading.Tasks.Task<T>> @internal, global::System.Func<global::System.Threading.Tasks.Task<T>> invalidForCSharp, global::System.Func<global::System.Threading.Tasks.Task<T>> @private, global::System.Func<global::System.Threading.Tasks.Task<T>> privateProtected, global::System.Func<global::System.Threading.Tasks.Task<T>> @protected, global::System.Func<global::System.Threading.Tasks.Task<T>> protectedInternal, global::System.Func<global::System.Threading.Tasks.Task<T>> @public) =>
		cSharpAccessModifier switch
		{
			FluentAssertions.Common.CSharpAccessModifier.Internal => await @internal().ConfigureAwait(false),
			FluentAssertions.Common.CSharpAccessModifier.InvalidForCSharp => await invalidForCSharp().ConfigureAwait(false),
			FluentAssertions.Common.CSharpAccessModifier.Private => await @private().ConfigureAwait(false),
			FluentAssertions.Common.CSharpAccessModifier.PrivateProtected => await privateProtected().ConfigureAwait(false),
			FluentAssertions.Common.CSharpAccessModifier.Protected => await @protected().ConfigureAwait(false),
			FluentAssertions.Common.CSharpAccessModifier.ProtectedInternal => await protectedInternal().ConfigureAwait(false),
			FluentAssertions.Common.CSharpAccessModifier.Public => await @public().ConfigureAwait(false),
			_ => throw new global::System.ArgumentException($"Unknown enum value from FluentAssertions.Common.CSharpAccessModifier: {cSharpAccessModifier.GetType().Name}")
		};
