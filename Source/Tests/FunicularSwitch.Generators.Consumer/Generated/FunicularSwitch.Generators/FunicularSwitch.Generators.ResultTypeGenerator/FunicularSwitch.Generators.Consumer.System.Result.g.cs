...
#pragma warning disable 1591
    ...
    {
        public static new Result<T> Error(Action message) => Error<T>(message);
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        public static implicit operator global::FunicularSwitch.Generic.GenericResult<T, Action>(Result<T> result) => 
            result.Match(
                global::FunicularSwitch.Generic.GenericResult<T, Action>.Ok,
                global::FunicularSwitch.Generic.GenericResult<T, Action>.Error);
        
        public static implicit operator Result<T>(global::FunicularSwitch.Generic.GenericResult<T, Action> result) =>
            result.Match<Result<T>>(
                Result<T>.Ok,
                Result<T>.Error);
        
        public global::FunicularSwitch.Generic.GenericResult<T, Action> ToGenericResult() =>
            Match(
                global::FunicularSwitch.Generic.GenericResult<T, Action>.Ok,
                global::FunicularSwitch.Generic.GenericResult<T, Action>.Error);
    ...
    public static partial class ResultExtension
    {
        ...
        public static Result<T> ToResult<T>(
            this global::FunicularSwitch.Generic.GenericResult<T, Action> result) =>
                result.Match<Result<T>>(
                    Result<T>.Ok,
                    Result<T>.Error);
        
        public static global::System.Threading.Tasks.Task<Result<T>> ToResult<T>(
            this global::System.Threading.Tasks.Task<global::FunicularSwitch.Generic.GenericResult<T, Action>> result) =>
                result.Match(
                    Result<T>.Ok,
                    Result<T>.Error);
        
        public static global::System.Threading.Tasks.Task<global::FunicularSwitch.Generic.GenericResult<T, Action>> ToGenericResult<T>(
            this global::System.Threading.Tasks.Task<Result<T>> result) =>
                result.Match(
                    global::FunicularSwitch.Generic.GenericResult<T, Action>.Ok,
                    global::FunicularSwitch.Generic.GenericResult<T, Action>.Error);
