...
#pragma warning disable 1591
    ...
    public abstract partial class Result<T> : Result, global::System.Collections.Generic.IEnumerable<T>
    {
        ...
        public new static Result<T> Error(ErrorInNamespaceWithDifferentResult message) => Error<T>(message);
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        public static implicit operator global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult>(Result<T> result) => 
            result.Match(
        ...
        public static implicit operator Result<T>(global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult> result) =>
            result.Match<Result<T>>(
                Result<T>.Ok,
                Result<T>.Error);
        
        public global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult> ToGenericResult() =>
            Match(
                global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult>.Ok,
                global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult>.Error);
    ...
    public readonly partial struct ResultError : global::System.IEquatable<ResultError>
    {
        ...
        internal ResultError(ErrorInNamespaceWithDifferentResult details) => _details = details;
    ...
    public static partial class ResultExtension
    {
        ...
        public static Result<T> ToResult<T>(
            this global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult> result) =>
                result.Match<Result<T>>(
                    Result<T>.Ok,
                    Result<T>.Error);
        
        public static global::System.Threading.Tasks.Task<Result<T>> ToResult<T>(
            this global::System.Threading.Tasks.Task<global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult>> result) =>
                result.Match(
                    Result<T>.Ok,
                    Result<T>.Error);
        
        public static global::System.Threading.Tasks.Task<global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult>> ToGenericResult<T>(
            this global::System.Threading.Tasks.Task<Result<T>> result) =>
                result.Match(
                    global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult>.Ok,
                    global::FunicularSwitch.Generic.GenericResult<T, ErrorInNamespaceWithDifferentResult>.Error);
...
namespace MyNamespace.Extensions
{
    public static partial class ResultExtension
    {
        ...
        public static global::System.Collections.Generic.IEnumerable<T1> Choose<T, T1>(
            ...
            global::System.Action<ErrorInNamespaceWithDifferentResult> onError)
            => items
                .Select(i => choose(i))
                .Choose(onError);
        ...
        public static Result<T> First<T>(this global::System.Collections.Generic.IEnumerable<T> candidates,  global::System.Func<T, bool> predicate,  global::System.Func<ErrorInNamespaceWithDifferentResult> noMatch) =>
            candidates
