...
#pragma warning disable 1591
    ...
    static partial class OperationResultExtension
    {
        ...
        public static OperationResult<T> FirstOk<T>(this System.Collections.Generic.IEnumerable<OperationResult<T>> results, System.Func<Error> onEmpty)
        {
        ...
        public static OperationResult<System.Collections.Generic.IReadOnlyCollection<T>> AllOk<T>(this System.Collections.Generic.IEnumerable<T> candidates, System.Func<T, System.Collections.Generic.IEnumerable<Error>> validate) =>
            candidates
        ...
        public static OperationResult<System.Collections.Generic.IReadOnlyCollection<T>> AllOk<T>(this System.Collections.Generic.IEnumerable<OperationResult<T>> candidates,
            System.Func<T, System.Collections.Generic.IEnumerable<Error>> validate) =>
            candidates
                .Bind(items => items.AllOk(validate));

        public static OperationResult<T> Validate<T>(this OperationResult<T> item, System.Func<T, System.Collections.Generic.IEnumerable<Error>> validate) => item.Bind(i => i.Validate(validate));

        public static OperationResult<T> Validate<T>(this T item, System.Func<T, System.Collections.Generic.IEnumerable<Error>> validate)
        {
	        try
	        {
...
#pragma warning restore CS0168 // Variable is declared but never used
	        {
		        return OperationResult.Error<T>(FunicularSwitch.Generators.Consumer.Error.Generic(e));
	        }
        }

        public static OperationResult<T> FirstOk<T>(this System.Collections.Generic.IEnumerable<T> candidates, System.Func<T, System.Collections.Generic.IEnumerable<Error>> validate, System.Func<Error> onEmpty) =>
            candidates
        ...
        static Error MergeErrors(System.Collections.Generic.IEnumerable<Error> errors)
        {
            var first = true;
            Error aggregated = default!;
