//HintName: FunicularSwitch.Generators.FluentAssertions.Consumer.Dependency.GenericUnionTypeWithConstraintsOfTFirst_TSecond_TThird_TFourthAssertions.g.cs
#nullable enable
...
namespace FunicularSwitch.Generators.FluentAssertions.Consumer.Dependency
{
    ...
    {
        public GenericUnionTypeWithConstraintsAssertions(global::FunicularSwitch.Generators.FluentAssertions.Consumer.Dependency.GenericUnionTypeWithConstraints<TFirst, TSecond, TThird, TFourth> value) : base(value, AssertionChain.GetOrCreate())
        {
