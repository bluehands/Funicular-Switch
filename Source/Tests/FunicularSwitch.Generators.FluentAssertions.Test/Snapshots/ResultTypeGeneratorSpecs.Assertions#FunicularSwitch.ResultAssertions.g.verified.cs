...
{
    internal partial class ResultAssertions<T> : ObjectAssertions<FunicularSwitch.Result<T>, ResultAssertions<T>>
    {
        public ResultAssertions(FunicularSwitch.Result<T> value) : base(value)
        {
        }
        ...
        public AndWhichConstraint<ResultAssertions<T>, System.String> BeError(string because = "",
