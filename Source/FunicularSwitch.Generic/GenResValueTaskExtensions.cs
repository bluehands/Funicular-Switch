...
public static class GenResValueTaskExtensions
{
    ...
    public static async ValueTask<bool> IsOk<TOk, TError>(
        this ValueTask<GenRes<TOk, TError>> genResTask)
    {
    ...
    [Pure]
    public static async ValueTask<GenRes<TOk, TError>> Do<TOk, TError>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
        Action<TOk> action)
    {
        var genRes = await genResTask.ConfigureAwait(false);
    ...
    [Pure]
    public static async ValueTask<GenRes<TOk, TError>> DoAsync<TOk, TError>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
    ...
    [Pure]
    public static async ValueTask<GenRes<TOk, TError>> DoOnError<TOk, TError>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
    ...
    [Pure]
    public static async ValueTask<GenRes<TOk, TError>> DoOnErrorAsync<TOk, TError>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
    ...
    [Pure]
    public static async ValueTask<GenRes<TOkReturn, TError>> Bind<TOk, TError, TOkReturn>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
    ...
    [Pure]
    public static async ValueTask<GenRes<TOkReturn, TError>> Map<TOk, TError, TOkReturn>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
    ...
    [Pure]
    public static async ValueTask<GenRes<TOk, TErrorReturn>> MapError<TOk, TError, TErrorReturn>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
    ...
    [Pure]
    public static async ValueTask<GenRes<TOkReturn, TError>> Select<TOk, TError, TOkReturn>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
    ...
    [Pure]
    public static async ValueTask<GenRes<TOkReturn, TError>> SelectMany<TOk, TError, TOkReturn>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
    ...
    [Pure]
    public static async ValueTask<GenRes<TSelect, TError>> SelectMany<TOk, TError, TOkReturn, TSelect>(
        this ValueTask<GenRes<TOk, TError>> genResTask,
        Func<TOk, GenRes<TOkReturn, TError>> selector,
